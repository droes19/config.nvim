local servers = require("droes.utils.util").get_files_and_value_as_table_from("droes/lsp/server")
...
vim.api.nvim_create_autocmd("InsertEnter", {
	callback = function()
		...
		vim.fn.system("cd " .. vim.fn.stdpath("data") .. "/site/pack/core/opt/LuaSnip && make install_jsregexp")
...
vim.api.nvim_create_autocmd("BufReadPre", {
	callback = function()
		...
		require("mason-tool-installer").setup { ensure_installed = ensure_installed_non_lsp }
